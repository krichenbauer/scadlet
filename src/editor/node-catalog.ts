...
const CATALOG_ENTRIES: readonly NodeCatalogEntry[] = [
  ...
  {
    type: 'number', category: 'values', labelKey: 'node.number', paletteDescriptionKey: 'palette.description.number', inputs: ['value'], outputs: ['value'],
    inputSocketType: (port) => port === 'value' ? 'number' : undefined, outputSocketType: (port) => port === 'value' ? 'number' : undefined,
  ...
  {
    type: 'boolean', category: 'values', labelKey: 'node.boolean', paletteDescriptionKey: 'palette.description.boolean', inputs: ['value'], outputs: ['value'],
    inputSocketType: (port) => port === 'value' ? 'boolean' : undefined, outputSocketType: (port) => port === 'value' ? 'boolean' : undefined,
  ...
  {
    type: 'vector3', category: 'values', labelKey: 'node.vector3', paletteDescriptionKey: 'palette.description.vector3', inputs: ['value', 'x', 'y', 'z'], outputs: ['value'],
    inputSocketType: (port) => port === 'value' ? 'vector3' : ['x', 'y', 'z'].includes(port) ? 'number' : undefined,
