...
const dictionaries: Record<LocaleId, Record<string, string>> = {
  en: {
    ...
    'palette.scadSettings': 'SCAD settings',
    ...
    'palette.description.scadSettings': 'SCAD settings for fragment count, minimum angle, and minimum size in the current scope.',
    ...
    'category.values': 'Values / Variables',
    'category.math': 'Math',
    'node.cube': 'Cube',
    ...
    'node.if': 'If',
    'node.scadSettings': 'SCAD settings',
    ...
    'settings.fn': 'Fragment count ($fn)',
    'settings.fa': 'Minimum angle ($fa)',
    'settings.fs': 'Minimum size ($fs)',
    'settings.onePerScope': 'Only one SCAD settings node is allowed in each Main or Module scope.',
    'control.value': 'Value',
    'control.operator': 'Operator',
    'control.name': 'Name',
    'control.overridden': 'Connected value overrides the saved fallback literal.',
    'control.connectedValue': 'Connected value',
    'control.fallbackValue': 'Fallback value',
    'output.number': 'Number output',
    'output.boolean': 'Boolean output',
    'output.vector3': 'Vector3 output',
    'output.result': 'Result',
    'output.variableReference': 'Variable value output',
    'variable.createReference': 'Create variable reference',
    'variable.nameRequired': 'Name this Value with a valid unique identifier before creating a reference.',
    'variable.invalidName': 'Variable names must be valid OpenSCAD identifiers.',
    'variable.duplicateName': 'A binding with this name already exists in this scope.',
    'variable.invalidScope': 'Variable references must stay in the same scope as their definition.',
    'variable.confirmDelete': 'Deleting "{name}" will also delete {count} variable reference(s). Continue?',
    'variable.confirmDeleteParameter': 'Deleting "{name}" will also delete {references} variable reference(s) and disconnect {connections} connection(s). Continue?',
    'variable.circularDependency': 'Variable bindings contain a circular dependency.',
    'control.size': 'Size',
    ...
    'toolbar.localProjects': 'My projects',
    'toolbar.examples': 'Examples',
    'toolbar.exampleOpenFailed': 'Could not create a local copy of the example',
    ...
    'render.liveDisabledSlow': 'Live rendering was turned off because the automatic preview reached its 15-second limit.',
