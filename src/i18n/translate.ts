...
const dictionaries: Record<LocaleId, Record<string, string>> = {
  en: {
    ...
    'definition.moduleCallsMainOnly': 'Module/Function Calls can only be placed in Main.',
    'definition.functionScopeIncompatible': 'Only value/math nodes are allowed inside a Function definition.',
